...
public class NativeJdbcWithTransaction {
    ...
    public static void main(String[] args) throws SQLException {
        ...
        NativeJdbcWithTransaction jdbc = new NativeJdbcWithTransaction();
    ...
    public void insertBatch() {
        if (connection != null) {
            try {
                PreparedStatement insertStmt = connection.prepareStatement("insert into student(id, name) values(?, ?)");
                for (int i = 3; i < 5; i++) {
